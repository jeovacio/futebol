...
naoBtn.addEventListener("mouseover", () => {
  attempts++;
  if (attempts >= 1) {
    mensagem.innerText = "nao meeeeente, marca logo godzila confuseiro";
  }
...
simBtn.addEventListener("click", function(){
  mensagem.innerText = "tu no teu dia mais tranquilo no futebol";
  setTimeout(() => {
    window.location.href = "https://www.youtube.com/shorts/UTytsvXbuC0"; // Coloque o link do vídeo desejado aqui
  }, 2000);
});
